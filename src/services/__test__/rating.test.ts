...
describe('Rating Service', () => {
  ...
  describe('Calculate rating for a given point', () => {
    ...
    it('should get a rating less than 1 for poor point', () => {
  ...
  describe('Get position based on points location', () => {
    ...
    it('should get thte point based on a south location', () => {
      const response = defaultRating.getPositionFromLocation(200);
      expect(response).toBe(GeoPositiion.S);
    });

    it('should get thte point based on a west location', () => {
      const response = defaultRating.getPositionFromLocation(300);
      expect(response).toBe(GeoPositiion.W);
    });
  });
});
